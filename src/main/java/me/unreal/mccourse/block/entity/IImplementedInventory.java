 ...
 */
@FunctionalInterface
public interface IImplementedInventory extends SidedInventory {
    /**
     ...
     */
    static IImplementedInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     * @return a new inventory
     */
    static IImplementedInventory ofSize(int size) {
